...
class TestExperimentPages(SessionTestCase):
    ...
    def test_edit_experiment_view(self):
        ...
        response = self.client.get(reverse("ab_testing_tool_edit_experiment", args=(self.resource_link_id, experiment.id,)))
        self.assertTemplateUsed(response, "ab_tool/edit_experiment.html")
    ...
    def test_edit_experiment_view_nonexistent(self):
        ...
        response = self.client.get(reverse("ab_testing_tool_edit_experiment", args=(self.resource_link_id,e_id,)))
        self.assertTemplateNotUsed(response, "ab_tool/edit_experiment.html")
    ...
    def test_submit_create_experiment(self):
        ...
        response = self.client.post(
            reverse("ab_testing_tool_submit_create_experiment", args=(self.resource_link_id,)), follow=True,
    ...
    def test_submit_edit_experiment(self):
        ...
        response = self.client.post(
            reverse("ab_testing_tool_submit_edit_experiment", args=(self.resource_link_id, experiment_id,)),
    ...
    def test_submit_edit_experiment_wrong_course(self):
        ...
        response = self.client.post(
            reverse("ab_testing_tool_submit_edit_experiment", args=(self.resource_link_id, experiment.id,)),
    ...
    def test_delete_experiment(self):
        ...
        response = self.client.post(reverse("ab_testing_tool_delete_experiment", args=(self.resource_link_id, experiment.id,)),
                                    follow=True)
    ...
    def test_delete_experiment_nonexistent(self):
        ...
        first_num_experiments = Experiment.objects.count()
        response = self.client.post(reverse("ab_testing_tool_delete_experiment", args=(self.resource_link_id,t_id,)), follow=True)
        second_num_experiments = Experiment.objects.count()
        self.assertEqual(first_num_experiments, second_num_experiments)
        self.assertOkay(response)
    ...
    def test_finalize_tracks(self):
        ...
        response = self.client.post(reverse("ab_testing_tool_finalize_tracks", args=(self.resource_link_id, experiment.id,)),
                                    follow=True)
        self.assertOkay(response)
        experiment = Experiment.get_placeholder_course_experiment(TEST_COURSE_ID)
    ...
    def test_finalize_tracks_missing_urls(self):
        ...
        InterventionPointUrl.objects.create(intervention_point=intervention_point,
                                            track=track1, url="example.com")
        response = self.client.post(reverse("ab_testing_tool_finalize_tracks", args=(self.resource_link_id, experiment.id,)), follow=True)
        self.assertOkay(response)
        experiment = Experiment.get_placeholder_course_experiment(TEST_COURSE_ID)
        self.assertFalse(experiment.tracks_finalized)
    ...
    def test_copy_experiment(self):
        ...
        experiment = self.create_test_experiment()
        num_experiments = Experiment.objects.count()
        url = reverse("ab_testing_tool_copy_experiment", args=(self.resource_link_id, experiment.id,))
    ...
    def test_copy_experiment_inavlid_id(self):
        ...
        url = reverse("ab_testing_tool_copy_experiment", args=(self.resource_link_id, 12345,))
        response = self.client.post(url, follow=True)
        self.assertEquals(response.status_code, 404)
