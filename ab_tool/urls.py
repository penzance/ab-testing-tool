...
urlpatterns = patterns('',
    ...
    url(r'^download_intervention_point_interactions/(?P<experiment_id>\d+)$', download_intervention_point_interactions,
        name='download_intervention_point_interactions'),
    ...
    url(r'^create_intervention_point/(?P<experiment_id>\d+)$', create_intervention_point, name='create_intervention_point'),
