...
urlpatterns = patterns('',
    ...
    url(r'^submit_create_intervention_point/(?P<resource_link_id>\w+)/(?P<experiment_id>\d+)$', submit_create_intervention_point, name='ab_testing_tool_submit_create_intervention_point'),
    #
    url(r'^modules_page_view_intervention_point/(?P<resource_link_id>\w+)/(?P<intervention_point_id>\d+)$', modules_page_view_intervention_point, name='ab_testing_tool_modules_page_view_intervention_point'),
    url(r'^modules_page_edit_intervention_point/(?P<resource_link_id>\w+)/(?P<intervention_point_id>\d+)$', modules_page_edit_intervention_point, name='ab_testing_tool_modules_page_edit_intervention_point'),
    url(r'^submit_edit_intervention_point/(?P<resource_link_id>\w+)/(?P<intervention_point_id>\d+)$', submit_edit_intervention_point, name='ab_testing_tool_submit_edit_intervention_point'),
    url(r'^submit_edit_intervention_point_from_modules/(?P<resource_link_id>\w+)/(?P<intervention_point_id>\d+)$', submit_edit_intervention_point_from_modules, name='ab_testing_tool_submit_edit_intervention_point_from_modules'),
    url(r'^intervention_point/(?P<resource_link_id>\w+)/(?P<intervention_point_id>\d+)$', deploy_intervention_point, name='ab_testing_tool_deploy_intervention_point'),
    ...
    url(r'^delete_track/(?P<resource_link_id>\w+)/(?P<track_id>\d+)$', delete_track, name='ab_testing_tool_delete_track'),
