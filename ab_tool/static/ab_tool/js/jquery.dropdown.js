...
$.fn.selectmenu = function(settings){
	...
	return $(this).each(function(){
		...
		var selectmenuIcon = $('<span class="custom-select-button-icon"><i class="fa fa-chevron-down"></i></span>').appendTo(button);
		...
		//menu.appendTo('body'); RM
		//this appendTo has to match on line 121
		menu.appendTo(selectElement.parent());//'.custom-dropdown' 
	...
	//specific events
		...
		//apply mousedown to button	so that the user can drag over the menu, and 
		//release teh mouse button to make selection
		// we could use click() and e.preventDefault, but won't be able to drag 
