...
class TestModels(SessionTestCase):
    ...
    def test_is_missing_urls_true(self):
        ...
        stage = InterventionPoint.objects.create(course_id=TEST_COURSE_ID, name="stage")
    ...
    def test_is_missing_urls_true_no_url(self):
        ...
        stage = InterventionPoint.objects.create(course_id=TEST_COURSE_ID, name="stage")
        track1 = Track.objects.create(course_id=TEST_COURSE_ID, name="track1")
        InterventionPointUrl.objects.create(stage=stage, track=track1)
        self.assertTrue(stage.is_missing_urls())
    ...
    def test_is_missing_urls_true_blank_url(self):
        ...
        stage = InterventionPoint.objects.create(course_id=TEST_COURSE_ID, name="stage")
        track1 = Track.objects.create(course_id=TEST_COURSE_ID, name="track1")
        InterventionPointUrl.objects.create(stage=stage, track=track1, url="")
        self.assertTrue(stage.is_missing_urls())
    ...
    def test_is_missing_urls_false(self):
        ...
        InterventionPointUrl.objects.create(stage=stage, track=track1, url="http://example.com")
        InterventionPointUrl.objects.create(stage=stage, track=track2, url="http://example.com")
